...
namespace POC.PdfGenerator.Aspose
{
    public class GeneratePdfTests
    {
        ...
        public void Test1()
        {
            ...
            (string Language, string Text)[] texts = new (string, string)[]
            {
                ("Chinese", "浅色模式"),
                ("English", "Light Mode"),
            ...
            {
                ColumnWidths = "500", // Define column widths
                DefaultCellBorder = new BorderInfo(BorderSide.None),
                Margin = new MarginInfo(0, 0, 0, 100) // Add some margin at the bottom
            };
            ...
            // Save the document
            pdfDocument.Save("output_with_header_footer_custom_font.pdf");
